...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if ($stmt = $conn->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                // Success - Store success message in a session variable
        ...
        <div class="wrapper mb-5">
            ...
            <div class="container mt-5 mb-4">
                <div class="row align-items-center justify-content-center">
                    ...
                    <!-- Right Column: Form -->
                    <div class="col-md-5 pb-4" data-aos="zoom-in">
        ...
        <div class="modal-dialog modal-dialog-centered m-auto">
            <div class="modal-content">
                <div class="modal-header position-relative">
                    <img src="images/check-circle-svgrepo-com.svg" alt="success icon" class="position-absolute start-50 translate-middle" width="100" style="top:-9px;"><br>
                </div>
    ...
    <script>
        ...
        window.onload = function() {
            <?php if (isset($_SESSION['feedback_success'])): ?>
                ...
                modal.show();
                <?php unset($_SESSION['feedback_success']); // Clear the session variable after showing the modal 
                ?>
            <?php endif; ?>
        }
    </script>
