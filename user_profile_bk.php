...
$sql = "SELECT userName, quiz_type, score, quiz_date FROM users, result WHERE users.id = result.user_id AND users.id = ?";

// Prepare statement
$stmt = $conn->prepare($sql);

// Bind parameters
$stmt->bind_param("i", $isLoggedIn);  // "i" means the parameter is an integer
...
<body class="primary-font">
    <div class="wrapper">
        ...
        <main class="flex-grow-1">
            ...
            <div class="table-responsive mb-5 px-5">
