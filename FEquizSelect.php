    ...
    <div class="content">
        <div class="wrapper">
            ...
            <div class="container text-center my-5">
                ...
                <p class="mb-3">Since 2024 the Question Criteria for FE Evening Changed,we've decided to not add the PM questions from 2023 to 2021.<br> You can still access to AM Questions And 2024 Questions.
                    Be ready and prepared for the Exam by testing your skill on our website.<br><span class=" text-danger">Warning:You are not able to continue the test when the timer gets 00:00:00</span></p>
                <div class="d-flex flex-wrap align-items-center justify-content-evenly mx-5">
                    <div class="text-start mb-3  d-flex flex-col justify-content-center align-items-center">
                        <div id="enableTimer" class="FEtoggle-switch" onclick="handleCheckboxChange(this)  ">
                    ...
                    <div class=" text-start mb-3 ms-2 d-flex flex-col justify-content-center align-items-center">
                        <div id="enableRandomQuiz" class="FEtoggle-switch" onclick="handleRandomCheckboxChange(this)  ">
                            <div class="slider"></div>
                        </div>
                ...
                <div class="container text-center mb-2 right-3">
                    <div class="input-group justify-content-center">
                        <div class="form-outline" data-mdb-input-init>
                            <input
                                type="text"
                                class="border border-success-subtle border-2 px-2 py-1 outline-none rounded"
                                id="searchInput"
                                onkeyup="searchYear()"
                            ...
                            <div class="card-body box-shadow_FEcolor">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-content">
                                        <a href="FEQuiz/FEQuiz2024/October/AM/FEQuiz.php" class="w-100 prevent-select">AM</a>
                                        <a href="FEQuiz/FEQuiz2024/October/PM/FEQuiz.php" class="w-100 prevent-select">PM</a>
                                    </div>
                                </div>
                            </div>
                        </div>
